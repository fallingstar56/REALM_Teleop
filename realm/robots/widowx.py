...
class WidowX(ManipulationRobot):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if end_effector == "gripper":
            self._model_name = "widowx"
            self._gripper_control_idx = th.arange(8) # TODO
            self._eef_link_names = "panda_link8"  # TODO
            self._finger_link_names = [
                "gripper_link_left_inner_finger", # TODO
                "gripper_link_right_inner_finger" # TODO
            ]
            self._finger_joint_names = [
                "left_inner_finger_prismatic_joint", # TODO
            ]
            ...
            self._ag_start_points = [
                GraspingPoint(link_name="panda_leftfinger", position=th.tensor([0.0, 0.001, 0.045])), # TODO
            ]
            self._ag_end_points = [
                GraspingPoint(link_name="panda_rightfigner", position=th.tensor([0.0, 0.001, 0.045])), # TODO
            ]
    ...
    def _create_discrete_action_space(self):
        raise ValueError("WidowX does not support discrete actions!")
    ...
    def arm_link_names(self):
        return {self.default_arm: [f"panda_link{i}" for i in range(8)]} # TODO

    @property
    def arm_joint_names(self):
        return {self.default_arm: [f"panda_joint{i+1}" for i in range(7)]} # TODO
    ...
    @property
    def usd_path(self):
        return os.path.join(gm.ASSET_PATH, f"/app/realm/robots/widowx/wxai_base.usd")

    @property
    def robot_arm_descriptor_yamls(self):
        #return {self.default_arm: os.path.join(gm.ASSET_PATH, f"models/panda_robotiq/panda_with_cam_description.yaml")}
        # TODO:
        return {self.default_arm: os.path.join(gm.ASSET_PATH, f"/app/realm/robots/widowx/wxai_base.yaml")} # TODO

    @property
    def urdf_path(self):
        return os.path.join(gm.ASSET_PATH, f"/app/realm/robots/widowx/wxai_base.urdf")
